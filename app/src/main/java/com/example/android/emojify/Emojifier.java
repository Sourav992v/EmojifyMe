...
/**
 * Created by Sourav on 5/15/2017.
 */
...
public class Emojifier {
    ...
    private static Emoji whichEmoji(Face face){
        ...
        Log.d(LOG_TAG, "getClassifications: smilingProbe = " + face.getIsSmilingProbability());

        Log.d(LOG_TAG, "getClassifications: leftEyeOpenProbe = " + face.getIsLeftEyeOpenProbability());

        Log.d(LOG_TAG, "getClassifications: rightEyeOpenProbe = " + face.getIsRightEyeOpenProbability());
        ...
        // Detemine and log the appropriate emoji
        Emoji emoji;
        if (smiling){
    ...
    private static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face){
        ...
        // Scale the emoji so that it looks better on the face
        float scaleFactor = EMOJI_SCALE_FACTOR;

        // Determine the size of the emoji to match the width of the face and persive aspect ratio
